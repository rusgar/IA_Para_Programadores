    ...
    modal.innerHTML = `
        <div class="pdf-preview-content">
            <div class="pdf-preview-header">
                <h2>📄 Vista Previa - Módulo 2: Generación y Optimización de Código con IA</h2>
...
console.log('🎓 Módulo 2: Generación y Optimización de Código con IA - Cargado correctamente');
