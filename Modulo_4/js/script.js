    ...
    modal.innerHTML = `
        <div class="pdf-preview-content">
            <div class="pdf-preview-header">
                <h2>📄 Vista Previa - Módulo 4: Desarrollo de Aplicaciones con APIs de IA</h2>
...
console.log('🎓 Módulo 4: Desarrollo de Aplicaciones con APIs de IA - Cargado correctamente');
